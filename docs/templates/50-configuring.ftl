...
1. Scroll down to the ${cli_config_header} section, click ${add_polaris_cli_button}, and complete the following:
    ...
    * *Required Installation directory*: To let ${solution_name} install the ${polaris_cli_name} from your ${polaris_product_name} server automatically, leave this box checked,
