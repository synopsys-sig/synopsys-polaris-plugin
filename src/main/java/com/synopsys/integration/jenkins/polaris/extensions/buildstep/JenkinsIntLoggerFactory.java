...
public class JenkinsIntLoggerFactory {

    public JenkinsIntLogger createJenkinsIntLogger(final BuildListener listener, final IntEnvironmentVariables intEnvironmentVariables) {
